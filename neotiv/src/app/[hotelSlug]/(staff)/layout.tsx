...
export default function FrontofficeLayout({
  ...
  return (
    <div className="flex h-screen bg-slate-50" style={{ fontFamily: 'var(--font-staff)' }}>
      {/* Sidebar */}
      <aside className="w-[280px] flex flex-col shadow-xl z-20" style={{ background: '#0B1120' }}>
        ...
        <nav className="flex-1 py-6 px-4 overflow-y-auto hide-scrollbar space-y-8">
          <div>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        {/* Top Navbar */}
        <header className="h-[72px] flex-shrink-0 flex items-center justify-between px-8 bg-white/80 backdrop-blur-md border-b border-slate-200/60 shadow-sm z-10 sticky top-0">
          <h2 className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-slate-800 to-slate-600 capitalize">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-teal-500 to-emerald-400 flex items-center justify-center text-white text-sm font-bold shadow-md shadow-teal-500/20 border-2 border-white">
